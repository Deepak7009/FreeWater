...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-gray-400 to-gray-300  py-8 px-4 overflow-hidden mt-5">
            <div className="container-fluid mx-auto flex flex-col md:flex-row justify-around items-center space-y-6 md:space-y-0">
                <div>
                    <div className="text-center md:text-left">
                        ...
                        <button className="my-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">
                            Contact Us
                        </button>
                    </div>
                    <div className="text-center md:text-left space-y-2">
                        <div className="flex justify-center md:justify-start space-x-4">                            <a href="/" className="hover:text-white">Projects</a>
                        </div>
                        <div className="flex justify-center md:justify-start space-x-4">
                            <a href="/" className="hover:text-white">Order FreeWater Boxes</a>
                        </div>
                        <div className="flex justify-center md:justify-start space-x-4">
                            <a href="/" className="hover:text-white">Order FreeWater Bottles</a>
                        </div>
                    </div>
                </div>
